...
/*Remove unused fluff for speed*/
function wpse_dequeue_google_fonts() {
    wp_dequeue_style( 'twentysixteen-fonts' );
}

add_action( 'wp_enqueue_scripts', 'wpse_dequeue_google_fonts', 100 );
...
//jetpack function for larger gravatars, which we don't use
...
function shapeSpace_include_custom_jquery() {
	...
	wp_enqueue_script('jquery', '/wp-includes/js/jquery/jquery.3.2.1.js', array(), '3.2.1', true);
...
function tn_dequeue_font_awesome_style() {
  ...
  wp_deregister_style( 'a3-lazy-load' );
